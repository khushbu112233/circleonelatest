...
public class DataHelper extends OrmLiteSqliteOpenHelper {
    ...
    public DataHelper(Context context) {
        super(context, context.getString(com.quickblox.q_municate_db.R.string.db_name), null, context.getResources().getInteger(
                com.quickblox.q_municate_db.R.integer.db_version), com.quickblox.q_municate_db.R.raw.orm);
