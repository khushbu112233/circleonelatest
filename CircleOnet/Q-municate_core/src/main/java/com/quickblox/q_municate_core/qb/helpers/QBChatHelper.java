...
public class QBChatHelper extends BaseThreadPoolHelper{
    ...
    public void sendMessageWithAttachment(Attachment.Type attachmentType, Object attachmentObject, String localPath) throws QBResponseException {
        ...
        switch (attachmentType) {
            case IMAGE:
                messageBody = context.getString(com.quickblox.q_municate_core.R.string.dlg_attached_last_message);
                attachment = getAttachmentImage((QBFile) attachmentObject, localPath);
                break;
            case LOCATION:
                messageBody = context.getString(com.quickblox.q_municate_core.R.string.dlg_location_last_message);
                attachment = getAttachmentLocation((String) attachmentObject);
                break;
            case VIDEO:
                messageBody = context.getString(com.quickblox.q_municate_core.R.string.dlg_attached_video_last_message);
                attachment = getAttachmentVideo((QBFile) attachmentObject, localPath);
                break;
            case AUDIO:
                messageBody = context.getString(com.quickblox.q_municate_core.R.string.dlg_attached_audio_last_message);
    ...
    public void sendChatMessage(QBChatMessage message, QBChatDialog chatDialog) throws QBResponseException {
        ...
        try {
            ...
            error = context.getString(com.quickblox.q_municate_core.R.string.dlg_fail_connection);
        }
        if (error != null) {
    ...
    private void sendNotificationBroadcast(String action, QBChatMessage chatMessage, QMUser user, String dialogId,
        ...
        if (!CollectionsUtil.isEmpty(chatMessage.getAttachments())) {
            ...
            extraChatMessage = context.getResources().getString(com.quickblox.q_municate_core.R.string.was_attached, attachment.getType());
        } else {
...
//            }
    ...
    private void createGroupDialogByNotification(QBChatMessage qbChatMessage, DialogNotification.Type notificationType) {
        qbChatMessage.setBody(context.getString(com.quickblox.q_municate_core.R.string.cht_notification_message));
    ...
    public QBFile loadAttachFile(File inputFile) throws Exception {
        ...
        try {
            ...
            throw new Exception(context.getString(com.quickblox.q_municate_core.R.string.dlg_fail_upload_attach));
        }
