...
public class ChatNotificationUtils {
    ...
    public static QBChatDialog parseDialogFromQBMessage(Context context, QBChatMessage qbChatMessage, QBDialogType qbDialogType) {
        ...
        if (!CollectionUtils.isEmpty(qbChatMessage.getAttachments())) {
            qbDialog.setLastMessage(context.getString(com.quickblox.q_municate_core.R.string.dlg_attached_last_message));
    ...
    private static void addNecessaryPropertyForCreatingSystemMessage(Context context,
        ...
        qbChatMessage.setBody(context.getResources().getString(com.quickblox.q_municate_core.R.string.cht_notification_message));
        ...
        switch (notificationType) {
            case FRIENDS_REQUEST: {
                resultMessage = ownMessage
                        ? resources.getString(com.quickblox.q_municate_core.R.string.frl_friends_request_message_for_me)
                        : resources.getString(com.quickblox.q_municate_core.R.string.frl_friends_request_message_for_friend,
                        ChatUtils.getFullNameById(dataManager, senderId));
                break;
            }
            case FRIENDS_ACCEPT: {
                resultMessage = ownMessage
                        ? resources.getString(com.quickblox.q_municate_core.R.string.frl_friends_request_accept_message_for_me)
                        : resources.getString(com.quickblox.q_municate_core.R.string.frl_friends_request_accept_message_for_friend);
                break;
            }
            case FRIENDS_REJECT: {
                resultMessage = ownMessage
                        ? resources.getString(com.quickblox.q_municate_core.R.string.frl_friends_request_reject_message_for_me)
                        : resources.getString(com.quickblox.q_municate_core.R.string.frl_friends_request_reject_message_for_friend);
                break;
            }
            case FRIENDS_REMOVE: {
                QMUser opponentUser;
                ...
                if (qbChatMessage.getRecipientId().intValue() == user.getId().intValue()) {
                    ...
                    resultMessage =
                            resources.getString(com.quickblox.q_municate_core.R.string.frl_friends_request_remove_message_for_friend,
                            opponentUser.getFullName());
                } else {
                    opponentUser = QMUserService.getInstance().getUserCache().get((long)qbChatMessage.getRecipientId());
                    resultMessage = resources.getString(com.quickblox.q_municate_core.R.string.frl_friends_request_remove_message_for_me,
                            opponentUser.getFullName());
                }
    ...
    public static String getBodyForUpdateChatNotificationMessage(Context context, DataManager dataManager,
        ...
        if (notificationType != null && notificationType.equals(NotificationType.GROUP_CHAT_CREATE)) {
            ...
            if (ownMessage) {
                ...
                resultMessage = resources.getString(com.quickblox.q_municate_core.R.string.cht_update_group_added_message, qbUser.getFullName(), fullNames);
            } else {
                fullNames = ChatUtils.getFullNamesFromOpponentId(dataManager, qbChatMessage.getSenderId(), addedOccupantsIdsString);
                resultMessage = resources.getString(com.quickblox.q_municate_core.R.string.cht_update_group_added_message, ChatUtils.getFullNameById(dataManager,
        ...
        if (chatNotificationType != null) {
            switch (chatNotificationType) {
                case CHAT_PHOTO:
                    resultMessage = ownMessage ? resources.getString(com.quickblox.q_municate_core.R.string.cht_update_group_photo_message,
                            qbUser.getFullName()) : resources.getString(com.quickblox.q_municate_core.R.string.cht_update_group_photo_message,
                            ChatUtils.getFullNameById(dataManager, qbChatMessage.getSenderId()));
                    break;
                case CHAT_NAME:
                    resultMessage = ownMessage ? resources.getString(com.quickblox.q_municate_core.R.string.cht_update_group_name_message,
                            qbUser.getFullName(), dialogName) : resources.getString(
                            com.quickblox.q_municate_core.R.string.cht_update_group_name_message, ChatUtils.getFullNameById(dataManager,
                ...
                case CHAT_OCCUPANTS:
                    ...
                    if (!TextUtils.isEmpty(addedOccupantsIdsString)) {
                        ...
                        resultMessage = ownMessage ?
                                resources.getString(com.quickblox.q_municate_core.R.string.cht_update_group_added_message, qbUser.getFullName(), fullNames)
                                : resources.getString(com.quickblox.q_municate_core.R.string.cht_update_group_added_message, ChatUtils.getFullNameById(dataManager, qbChatMessage.getSenderId()),
                                fullNames);
                    }
                    ...
                    if (!TextUtils.isEmpty(deletedOccupantsIdsString)) {
                        ...
                        resultMessage = ownMessage ?
                                resources.getString(com.quickblox.q_municate_core.R.string.cht_update_group_leave_message, qbUser.getFullName())
                                : resources.getString(com.quickblox.q_municate_core.R.string.cht_update_group_leave_message, fullNames);
                    }
