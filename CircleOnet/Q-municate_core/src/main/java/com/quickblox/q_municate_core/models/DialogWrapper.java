...
public class DialogWrapper implements Serializable {
    ...
    private void fillLastMessage(Context context, DataManager dataManager, List<Long> dialogOccupantsIdsList){
        ...
        lastMessage = ChatUtils.getDialogLastMessage(context.getResources().getString(com.quickblox.q_municate_core.R.string.cht_notification_message), message, dialogNotification);
    }
