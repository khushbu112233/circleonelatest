...
public class SettingsUtil {
    ...
    private static void setSettingsFromPreferences(Context context) {
        ...
        boolean hwCodec = coreSharedHelper.getCallHwCodec(
                context.getResources().getBoolean(com.quickblox.q_municate_core.R.bool.call_hw_codec_default));

        QBRTCMediaConfig.setVideoHWAcceleration(hwCodec);

        // Get video resolution from settings.
        int resolutionItem = coreSharedHelper.getCallResolution(
                context.getResources().getInteger(com.quickblox.q_municate_core.R.integer.call_resolution_default));
        ...
        // Get start bitrate.
        String bitrateTypeDefault = context.getString(com.quickblox.q_municate_core.R.string.call_startbitrate_default);
        ...
        if (!bitrateType.equals(bitrateTypeDefault)) {
            int bitrateValue = coreSharedHelper.getCallStartbitrateValue(
                    context.getResources().getInteger(com.quickblox.q_municate_core.R.integer.call_startbitrate_value_default));
            QBRTCMediaConfig.setVideoStartBitrate(bitrateValue);
        }

        int videoCodecItem = coreSharedHelper.getCallVideoCodec(
                context.getResources().getInteger(com.quickblox.q_municate_core.R.integer.call_video_codec_default));
        ...
        String audioCodecDescription = coreSharedHelper.getCallAudioCodec(
                context.getString(com.quickblox.q_municate_core.R.string.call_audio_codec_default));
