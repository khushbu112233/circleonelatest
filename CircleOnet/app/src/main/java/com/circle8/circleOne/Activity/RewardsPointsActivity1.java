...
public class RewardsPointsActivity1 extends AppCompatActivity implements View.OnClickListener
{
    View view;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        context = RewardsPointsActivity1.this;
...
//                Toast.makeText(getBaseContext(), selected+" "+mID, Toast.LENGTH_LONG).show();
    ...
    private void getHistory()
    {
        ...
        ListAdapter1 adapter = new ListAdapter1(context, items);
...
//                                            childList.add(j,ProductName);
                            ...
                            merchantExpandableAdapter = new MerchantExpandableAdapter(context, categoryList, categorysData);
                            activityRewardsPointsBinding.icdMerchantLayout.laptopList.setAdapter(merchantExpandableAdapter);
                        }
                ...
                if (result != null)
                {
                    ...
                    try
                    {
                        ...
                        if (jsonArray.length() != 0)
                        {
                            ...
                            earnPointsAdapter = new EarnPointsAdapter(context, earnPointsModelsList);
