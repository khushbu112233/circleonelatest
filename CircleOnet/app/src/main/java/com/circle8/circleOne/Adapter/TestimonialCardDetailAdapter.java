...
public class TestimonialCardDetailAdapter extends BaseSwipeAdapter
{
    ...
    public TestimonialCardDetailAdapter(Context context, int grid_list3_layout, ArrayList<TestimonialModel> testimonialModels)
    {
