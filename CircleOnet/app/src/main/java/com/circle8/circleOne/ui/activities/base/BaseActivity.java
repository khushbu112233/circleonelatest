package com.circle8.circleOne.ui.activities.base;
...
import com.circle8.circleOne.ui.activities.authorization.SplashActivity;
import com.circle8.circleOne.ui.activities.call.CallActivity;
import com.circle8.circleOne.ui.activities.chats.GroupDialogActivity;
import com.circle8.circleOne.ui.activities.chats.PrivateDialogActivity;
import com.circle8.circleOne.ui.fragments.dialogs.base.ProgressDialogFragment;
import com.circle8.circleOne.Common.ToastUtils;
import com.circle8.circleOne.Common.bridges.ActionBarBridge;
import com.circle8.circleOne.Common.bridges.ConnectionBridge;
import com.circle8.circleOne.Common.bridges.LoadingBridge;
import com.circle8.circleOne.Common.bridges.SnackbarBridge;
import com.circle8.circleOne.Common.broadcasts.NetworkChangeReceiver;
import com.circle8.circleOne.Common.helpers.ActivityUIHelper;
import com.circle8.circleOne.Common.helpers.FirebaseAuthHelper;
import com.circle8.circleOne.Common.helpers.LoginHelper;
import com.circle8.circleOne.Common.helpers.SharedHelper;
import com.circle8.circleOne.Common.helpers.notification.NotificationManagerHelper;
import com.circle8.circleOne.Common.listeners.ServiceConnectionListener;
import com.circle8.circleOne.Common.listeners.UserStatusChangingListener;
...
public abstract class BaseActivity extends AppCompatActivity implements ActionBarBridge, ConnectionBridge, LoadingBridge, SnackbarBridge {
    ...
    public static SharedHelper appSharedHelper;
    ...
    private void initFields() {
        ...
        appSharedHelper = MyApplication.getInstance().getAppSharedHelper();
