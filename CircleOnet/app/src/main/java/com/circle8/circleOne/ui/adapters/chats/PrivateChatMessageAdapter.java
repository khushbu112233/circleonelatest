package com.circle8.circleOne.ui.adapters.chats;
...
import com.circle8.circleOne.Common.DateUtils;
import com.circle8.circleOne.Common.listeners.FriendOperationListener;
...
public class PrivateChatMessageAdapter extends BaseChatMessagesAdapter implements StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder> {
    ...
    @Override
    protected void onBindViewAttachRightVideoHolder(QBMessagesAdapter.VideoAttachHolder holder, CombinationMessage chatMessage, int position) {
        showSendStatusView(holder, chatMessage);
        super.onBindViewAttachRightVideoHolder(holder, chatMessage, position);
    }

    @Override
    protected void onBindViewAttachLeftVideoHolder(QBMessagesAdapter.VideoAttachHolder holder, CombinationMessage chatMessage, int position) {
        setViewVisibility(holder.avatar, View.GONE);
        updateMessageState(chatMessage, chatDialog);
    ...
    @Override
    protected void onBindViewAttachLeftAudioHolder(QBMessagesAdapter.AudioAttachHolder holder, CombinationMessage chatMessage, int position) {
        setViewVisibility(holder.avatar, View.GONE);
        updateMessageState(chatMessage, chatDialog);
    ...
    @Override
    protected void onBindViewAttachRightAudioHolder(QBMessagesAdapter.AudioAttachHolder holder, CombinationMessage chatMessage, int position) {
        showSendStatusView(holder, chatMessage);
        super.onBindViewAttachRightAudioHolder(holder, chatMessage, position);
    }

    private void showSendStatusView(QBMessagesAdapter.BaseAttachHolder holder, CombinationMessage chatMessage) {
    ...
    @Override
    protected QBMessagesAdapter.QBMessageViewHolder onCreateCustomViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    protected void showAttachUI(QBMessagesAdapter.ImageAttachHolder viewHolder, boolean isIncoming) {
    ...
    protected static class FriendsViewHolder extends QBMessagesAdapter.QBMessageViewHolder {
        @Nullable
