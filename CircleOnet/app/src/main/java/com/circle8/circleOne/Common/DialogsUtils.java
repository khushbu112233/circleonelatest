...
public class DialogsUtils {
    ...
    public static void showOpenAppSettingsDialog(FragmentManager fm, final String dialogMessage, final MaterialDialog.ButtonCallback callback) {
        ...
        TwoButtonsDialogFragment.showDelayed(
                fm,
                MyApplication.getInstance().getString(R.string.app_name),
                dialogMessage,
                MyApplication.getInstance().getString(R.string.dlg_cancel),
                MyApplication.getInstance().getString(R.string.dlg_open_app_settings),
                callback,
